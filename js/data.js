...
const workData=[
    ...
    },
    {
        ...
        title:'RENÉE RECYCLE',
        intro: 'Renée’s savoir-faire is built around four pillars: recovery, recycling, restoration and reuse of objects that are considered to be at the end of their life.',
        extraInfo:'Renée’s philosophy: the eternal recommencement. Renée responds to the environmental challenges of our time by rejecting waste and offers an alternative to the current consumption model. Renée has chosen to dedicate her life to bringing up to date what must remain alive. It does not matter what: fashion, decorative objects, furnitures or textiles. All are collected and transformed to give them a new purpose and a new life.',
    ...
    },
    {
        ...
        intro: 'A typographical interpretation of the book "Exercices de Style" by Raymond Queneau.',
